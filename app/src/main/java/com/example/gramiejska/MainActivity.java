...
public class MainActivity extends AppCompatActivity {
                    ...
                    new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location location) {
                            if(location != null){
                                ...
                                double dlugoscLokalizacja = ostatnioLokalizacja.getLongitude();
                                String tekst ="Szerokość geograficzna: "+szerokoscLokalizacja+
                                        " Długość geograficzna "+dlugoscLokalizacja;
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResult){
        ...
        if(grantResult.length>0){
            ...
            Log.d("Lokalizacja","Udzielona zgoda");
            Toast.makeText(this,
                    "nasza aplikacja wymaga twojej lokalizacji, jeżeli się nie zgodzisz będzie bezużyteczna", Toast.LENGTH_SHORT).show();
        }
    }
}